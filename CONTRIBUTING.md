# Contributing to `minder-mcp` <!-- omit from toc -->

First off, thank you for taking the time to contribute to minder-mcp! :+1: :tada: minder-mcp
...
started. You can find some hints for starting development in minder-mcp's
[README](https://github.com/stacklok/minder-mcp/blob/main/README.md).
...
[Contributor Covenant](https://github.com/stacklok/minder-mcp/blob/main/CODE_OF_CONDUCT.md)
...
If you think you have found a security vulnerability in minder-mcp please DO NOT
...
[process](https://github.com/stacklok/minder-mcp/blob/main/SECURITY.md)
...
["good first issue"](https://github.com/stacklok/minder-mcp/issues?q=is%3Aopen+is%3Aissue+label%3A%22good+first+issue%22)
...
- Fork the minder-mcp repository to your own GitHub account and clone it locally.
...
- Every pull request requires a review from the core minder-mcp team before merging.
